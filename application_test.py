...
from utilities.middleware_userservice import middleware
from utilities.sns_service import sns_slack
...
#             if res is not None:
#                 rsp = Response(json.dumps(res), status=200, content_type="application/json")
#                 snsClient.send_to_slack("A new user is added to our RDS database.")
#             else:
#                 rsp = Response("NOT FOUND", status=404, content_type="text/plain")
#         else:
